...
static const struct hid_blacklist {
	...
	/* Neverware: Macbook Pro 9,2 needs init_report run to work properly [OVER-7513] */
	{ USB_VENDOR_ID_APPLE, USB_DEVICE_ID_APPLE_WELLSPRING5A_ANSI, HID_QUIRK_ALWAYS_INIT_REPORT },
